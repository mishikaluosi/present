...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/waibao/present/trunk/Public/Home/default/images/favicon.ico" media="screen" />
    <script type="text/javascript" src="/waibao/present/trunk/Public/Home/default/js/jquery.min.js"></script>
    <script src="/waibao/present/trunk/Public/Home/default/js/laydate/laydate.js"></script> <!-- 改成你的路径 -->
    <link href="/waibao/present/trunk/Public/Home/default/css/wenjuan.css" rel="stylesheet">
</head>
...
<form method='post' id="form_do" name="form_do" action="<?php echo U('Wenjuan/save');?>">
    <div class="wjContent clear">
        <div class="head_div">
            <?php if($wenjuan.pic): ?><img alt="<?php echo ($v["name"]); ?>" src="/waibao/present/trunk/uploads//<?php echo ($wenjuan["pic"]); ?>" class="header_img"><?php endif; ?>
        </div>
        <div class="content">
            <div class="wjtitle ">
