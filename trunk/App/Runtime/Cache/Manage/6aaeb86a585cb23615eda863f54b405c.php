...
<script type="text/javascript" src="/waibao/present/trunk/App/Manage/View/Public/js/common.js"></script>
    ...
    <script type="text/javascript" src="/waibao/present/trunk/App/Manage/View/Public/shop/js/global.js"></script>
    <script type="text/javascript" src="/waibao/present/trunk/App/Manage/View/Public/shop/js/arttpl.js"></script>
    <script type="text/javascript" src="/waibao/present/trunk/App/Manage/View/Public/shop/plugin/layer/layer.js"></script>
            ...
            <table width="100%">
                ...
                <?php if(is_array($info_list)): foreach($info_list as $k=>$v): $sel = in_array($v['order_state'], array('success', 'close')) ? 'hy_ordertw' : 'hy_ordertt'; ?>
                    ...
                    <tr>
                                    ...
                                    <tr>
                                        <td width="50">
                                            <a href="#" target="_blank">
                                                <img src="/waibao/present/trunk/uploads//<?php echo (get_picture($vv['product_logo'],100,100)); ?>" width="40" height="40" class="imgbg" />
                                            </a>
                                        </td>
                                        <td>
                        ...
                        <td class="fufa">
                            <img src="/waibao/present/trunk/App/Manage/View/Public/images/fu_<?php echo ($v['order_pstate']); ?>.png" title="<?php echo (pe_date($v['order_ptime'])); ?>" />
                            <img src="/waibao/present/trunk/App/Manage/View/Public/images/fa_<?php echo ($v['order_sstate']); ?>.png" title="<?php echo (pe_date($v['order_stime'])); ?>" />
                        </td>
