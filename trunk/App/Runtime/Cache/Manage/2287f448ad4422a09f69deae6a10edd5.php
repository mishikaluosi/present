        ...
        <table width="100%">
            ...
            <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                    ...
                    <td class="aleft" style="width: 250px;">
                        <img  src="/waibao/present/trunk/uploads//<?php echo ($v["pic"]); ?>" style="width:40px;">
                        <?php echo ($v["name"]); ?>
                    </td>
                    ...
                    <td>
                        <?php if($v['status'] == 1): ?><img src="/waibao/present/trunk/App/Manage/View/Public/images/dui.png" onclick="toConfirm('<?php echo U('Wenjuan/status',array('id' => $v['id'],'flag' =>0));?>', '确定要下线该问卷吗？')">
                            <?php else: ?>
                            <img src="/waibao/present/trunk/App/Manage/View/Public/images/cuo.png" onclick="toConfirm('<?php echo U('Wenjuan/status',array('id' => $v['id'],'flag' =>1));?>', '确定要发布该问卷吗？')"><?php endif; ?>
                    </td>
                    <td>
