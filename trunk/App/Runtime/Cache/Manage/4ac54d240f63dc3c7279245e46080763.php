    ...
    <form action="<?php echo U('Event/delAll');?>" method="post" id="form_do" name="form_do">
        <table width="100%">
            ...
            <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                    ...
                    <td>
                        <?php if($v['status'] == 1): ?><img src="/waibao/present/trunk/App/Manage/View/Public/images/dui.png" onclick="toConfirm('<?php echo U('Event/status',array('id' => $v['id'],'flag' =>0));?>', '确定要下线该活动吗？')">
                            <?php else: ?>
                            <img src="/waibao/present/trunk/App/Manage/View/Public/images/cuo.png" onclick="toConfirm('<?php echo U('Event/status',array('id' => $v['id'],'flag' =>1));?>', '确定要发布该活动吗？')"><?php endif; ?>
                    </td>
                    <td>
