...
<div class="main">
    ...
    <div class="operate">
        <div class="left" style="float: left;margin-top:8px">
            <form method="post" action="<?php echo U('Order/export_zctj_ex');?>">
        ...
        <div class="left" style="float: left;margin-top:8px">
            <form method="post" action="<?php echo U('Order/export_zctj_ex_wgm');?>">
                <?php if(is_array($search_p)): foreach($search_p as $k=>$v): ?><input type="hidden" name="<?php echo ($k); ?>" value="<?php echo ($v); ?>"/><?php endforeach; endif; ?>
                <input type="submit" class="btn_blue btn_red" style="float: none" value="无购买职场导出">
            </form>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <div class="operate">
        <div class="left">
            <form method="post" action="<?php echo U('Order/zctj');?>">
    ...
    <div class="list">
        <table width="100%">
            ...
            <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                    ...
                    <td><?php echo ($v["zc"]); ?></td>
                    <td>
                        <img src="/waibao/present/trunk/uploads//<?php echo (get_picture($v['litpic'],100,100)); ?>" width="40" height="40" class="imgbg" />
                        <?php echo ($v["product"]); ?>
                    </td>
