...
namespace Common\Lib\Aliyun\Core;
use Common\Lib\Aliyun\Core\Exception\ClientException;
use Common\Lib\Aliyun\Core\Exception\ServerException;
use Common\Lib\Aliyun\Core\Regions\EndpointProvider;
use Common\Lib\Aliyun\Core\Http\HttpHelper;
