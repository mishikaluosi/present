...
<div class="main">
    <div class="pos">职场商品分类发货清单</div>
    <div class="operate">
        <div class="left" style="float: left;margin-top:8px">
            <form method="post" action="<?php echo U('Order/export_zccptj_ex');?>">
    ...
    <div class="operate">
        <div class="left">
            <form method="post" action="<?php echo U('Order/zccptj');?>">
    ...
    <style>
        .list tr td:first-child{width:140px!important;}
    </style>
    <div class="list">
        <table width="100%">
            <tr>
                <th rowspan="2" >职场</th>
                <th rowspan="2" style="width:40px">自购人数</th>
                <th colspan="3" style="width: 220px;">商品情况</th>
                <th rowspan="2" style="">合计数量</th>
                <th rowspan="2" style="">金额</th>
                <th rowspan="2" style="">省</th>
                <th rowspan="2" style="">市</th>
                <th rowspan="2" style="">区</th>
                <th rowspan="2" style="">联系人</th>
                <th rowspan="2" style="">联系电话</th>
