...
<head>
	...
	<link rel='stylesheet' type="text/css" href="/App/Manage/View/Public/css/style_shop.css" />
	<script type="text/javascript">
        $(function () {
				...
				<div class="form">
					<dl>
						...
						<dd>
							...
							<div id="show_1">
								<?php if($vo['pic']): ?><img src="/uploads/<?php echo ($vo["pic"]); ?>" width='250' /><?php endif; ?>
							</div>
						</dd>
					</dl>
					...
					<div class="right_main">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list" id="rule_data">
							...
							<?php if(is_array($info_list)): foreach($info_list as $k=>$v): ?><tr class="ruledata_list"  >
									...
									<td>
										<img style="cursor:pointer;" title="向上移动" class="icon_up mat3" src="/App/Manage/View/Public/images/icon_up.gif" />
										<img style="cursor:pointer;" title="向上移动" class="icon_down mat3 mal10" src="/App/Manage/View/Public/images/icon_down.gif" />
										<img style="cursor:pointer;" title="删除" class="icon_del mat3 mal10" onclick="rule_del(this, 0)" src="/App/Manage/View/Public/images/icon_del.gif" />
									</td>
