...
<script type="text/javascript" src="/App/Manage/View/Public/js/common.js"></script>
 <script language="JavaScript">
        <!--
        var URL = '/index.php?s=/Manage/Menu';
        var APP	 = '/index.php?s=';
        var SELF='/index.php?s=/Manage/Menu/index';
...
<div class="main">
    ...
    <div class="operate">
        <div class="left"><input type="button" onclick="goUrl('<?php echo U('Menu/add');?>')" class="btn_blue btn_red" value="添加菜单">
        <input type="button" onclick="doGoSubmit('<?php echo U('Menu/sort');?>','form_do')" class="btn_blue btn_red" value="更新排序" />
        <input type="button" onclick="doGoSubmit('<?php echo U('Menu/qk');?>','form_do')" class="btn_blue btn_red" value="更新快捷面板" />
    </div>
    <div class="clear"></div>
    </div>
