...
<div class="main">
    ...
    <div class="zc_box2" style="margin-top:22px">
        <div class="zc_list">
            <div class="zc_name">职场名：</div>
            <div class="zc_text"><?php echo ($zc["name"]); ?></div>
        </div>
        <div class="zc_list">
            <div class="zc_name">区域：</div>
            <div class="zc_text"><?php echo ($zc["prov"]); ?>-<?php echo ($zc["city"]); ?>-<?php echo ($zc["area"]); ?></div>
        </div>
        <div class="zc_list">
            <div class="zc_name">地址：</div>
            <div class="zc_text"><?php echo ($zc["addr"]); ?></div>
        </div>
        <div class="zc_list">
            <div class="zc_name">联系人：</div>
            <div class="zc_text"><?php echo ($zc["contact"]); ?></div>
        </div>
        <div class="zc_list">
            <div class="zc_name">联系电话：</div>
            <div class="zc_text"><?php echo ($zc["tel"]); ?></div>
        </div>
