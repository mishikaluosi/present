...
<div class="total" style="background:#fff;height: 50px;width: 100%;position: fixed;z-index:2;left: 0;bottom: 57px;border-top: 1px solid #ccc;">
    <div style="width:calc(25% - 1px);float: left;text-align: center;border-right: 1px solid #ccc;">
    ...
    <div style="width:calc(25% - 1px);float: left;text-align: center;border-right: 1px solid #ccc;">
        <p style="width: 100%;height: 25px;color: #009900;line-height: 25px;"><?php echo ($total_app); ?></p>
        <p style="width: 100%;height: 25px;line-height: 25px;">客户数</p>
    </div>
    <div style="width:calc(25% - 1px);float: left;text-align: center;border-right: 1px solid #ccc;">
        <p style="width: 100%;height: 25px;color: #009900;line-height: 25px;"><?php echo ($total_active); ?></p>
        <p style="width: 100%;height: 25px;line-height: 25px;">到会数</p>
    </div>
    <div style="width: 25%;float: left;text-align: center;">
        <p style="width: 100%;height: 25px;color: #009900;line-height: 25px;"><?php echo ($total_active_per); ?></p>
        <p style="width: 100%;height: 25px;line-height: 25px;">到会率</p>
    </div>
</div>
﻿<div class="foot_nav">
    <ul>
