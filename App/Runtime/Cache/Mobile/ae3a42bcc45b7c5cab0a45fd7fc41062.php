...
<div class="button-sp-area">
    <a href="<?php echo U('user/event_list',array('type'=>'1'));?>" class="weui-btn weui-btn_primary">市公司活动列表</a>
    <a href="<?php echo U('user/event_list',array('type'=>'2'));?>" class="weui-btn weui-btn_primary">支公司活动列表</a>
    <a href="<?php echo U('user/event_list',array('type'=>'3'));?>" class="weui-btn weui-btn_primary">职场活动列表</a>
</div>
</div>
﻿<div class="foot_nav">
    <ul>
